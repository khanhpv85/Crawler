 ...
 */
public class JellyfishCrawlSiteVNWController {
  private static Logger logger = LoggerFactory.getLogger(JellyfishCrawlSiteVNWController.class);
...
*/
     ...
     * stored.
     */
    String crawlStorageFolder = "/crawler4j/storage";//args[0];
     ...
     */
    config.setUserAgentString("JellyfishHR");
    ...
    */
    ...
    //controller.addSeed("http://www.vietnamworks.com/");
    controller.addSeed("http://www.vietnamworks.com/tim-viec-lam/");
    /*
     ...
     */
    controller.start(JellyfishCrawlerSiteVNW.class, numberOfCrawlers);
  }
}